                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo"<td width='10'>" . $count . "</td>";
                                                 ...
                                                 echo"<td width='100'>" . $row["message"] . "</td>";
                                                  ...
                                                  echo '<td style ="text-align: center;"><a class="btn btn-warning " href= "editrequest.php?id='.$row["id"].'"><i class="icon-pencil"></i></a><a class="btn btn-danger" href="deleterequest.php?id='.$row["id"].'"><i class="icon-trash"  ></i></a></td>';
                                                echo "</tr>";
                                                $count++ ;
                                                ?>
                                                <?php
