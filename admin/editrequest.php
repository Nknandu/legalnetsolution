        ...
        <div  class="widget-content nopadding">
          <form action="#" method="POST" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="id" id="id" placeholder="Enter your id " />
              </div>
            </div>
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11"  name="category" id="category" placeholder="Cateogry" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="lawyer" id="lawyer"  placeholder=" Lawyer contact details" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="textarea"  class="span11"  name="message" id="message" placeholder="Enter details of case"  />
...
if (isset($_POST["submit"])) {
   ...
   $lawyers = $_POST["lawyer"];
    ...
    $sql = "update request set caseid ='$case',casecategorye='$category',lawyer='$lawyers',	message	='$message'  where id='$vid' ";
    if ($conn->query($sql) === TRUE) {
        //mysql_query("delete from expense where e_id='$eid'");
        echo " <script>alert('Successfully Upadted  Details');window.location.href='viewrequest.php';</script>";
    } else {
        echo " <script>alert('Deatils not able to edit...!');window.location.href='viewrequest.php';</script>";
    }

}
$sql = "SELECT * from  request where id='".$vid."'";

$result = $conn->query($sql);

if ($row = $result->fetch_assoc()) {
    $case = $row["caseid"];
    $category = $row["casecategorye"];
    $lawyers = $row["lawyer"];
    $message  = $row["message"];
...
?>
<script>
    var id = "<?php echo $case; ?>";
    var cat = "<?php echo $category; ?>";
    var law = "<?php echo $lawyers; ?>";
    ...
    document.getElementById("category").value = cat;
     document.getElementById("lawyer").value = law;
