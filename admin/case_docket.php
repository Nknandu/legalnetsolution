        ...
        <div  class="widget-content nopadding">
          <form action="#" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Date of case :</label>
              <div class="controls">
            ...
            <div class="control-group">
              <label class="control-label">Time of case :</label>
              <div class="controls">
			...
			<label class="control-label">Docket Number  :</label>
              <div class="controls">
                   <?php
           include('confi.php');
                    $get=mysql_query("SELECT id FROM caseregistration where status='Approved'");
                    ?>
                <select name="docket" >
...
//$client =  $_SESSION["clientname"];
    $status='NEW';
     $sql ="select * from case_docket where case_date = '".$date."'and case_time= '".$time."' and docket_number = '".$docket."'  and lawyer_name = '".$lawyer."' and description = '".$details."'  ";
   //print_r($sql);
   ...
   if ($count == 0) {
       $query ="INSERT INTO case_docket(case_date,case_time,docket_number,lawyer_name,description) values('$date','$time','$docket','$lawyer','$details')";
    //   print_r($query);
