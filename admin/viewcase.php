                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo"<td width='100'>" . $row["status"] . "</td>";
                                                 ...
                                                 echo"<td width='100'>" . $row["lawyername"] . "</td>";
                                                  ...
                                                  //echo '<td><a class="btn btn-warning " href= "editcase.php?id='.$row["id"].'"><i class="icon-pencil"></i></a><a class="btn btn-danger" href="deletecase.php?id='.$row["id"].'"><i class="icon-trash"  ></i></a></td>';
                                                echo "</tr>";
                                                $count++ ;
                                                ?>
                                                <?php
