        ...
        <div  class="widget-content nopadding">
          <form action="#" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" class="span11" name="experience" placeholder="years" />
              </div>
            </div>
            <div class="control-group">
			  ...
			  <?php
           include('confi.php');
                    $get=mysql_query("SELECT * FROM category ");
                    ?>
           ...
           <!--        < } ?>-->
           <!--     </select>-->
                <!--<input type="text" class="span11"  name="category" placeholder="category" />-->
                
              </div>
            <div class="control-group">
              <label class="control-label">Email :</label>
              <div class="controls">
                <input type="email" class="span11"  name="email" placeholder="mail"  required="" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" class="span11" name="phone" placeholder=" contactnumber" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Praticearea :</label>
              <div class="controls">
                <input type="textarea" class="span11"  name="pratice" placeholder="" />
              </div>
            </div><div class="control-group">
              <label class="control-label">Username :</label>
              <div class="controls">
                <input type="text" class="span11"  name="user" placeholder="username" />
              </div>
            </div>
            <div class="control-group">
...
if (isset($_POST["submit"])) {
    ...
    $password = $_POST["password"];
     $sql ="select * from addlawyers where name = '".$name."'and experience = '".$experience."'and category = '".$category."'  and email = '".$email."' and   phone = '".$number."'and pratice = '".$pratice."'and user = '".$username."' and password = '".$password."' and lawyername = '".$name."' ";
   ...
   if ($count == 0) {
      $query ="INSERT INTO  addlawyers(name,experience,category,email,phone,pratice,user,password,lawyername) values('$name','$experience','$category','$email','$number','$pratice','$username','$password','$name')";
       
        mysql_query($query);
       // echo $query;
      echo" <script>alert('added successfully');window.location.href='form-common.php';</script>";
