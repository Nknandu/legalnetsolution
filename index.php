				...
				<div class="navbar-top">
					...
					<div class="navbar-header">
						...
						<div class="navbar-brand logo ">
							<h1><a href="index.html"> Court Management <i class="fa fa-balance-scale" aria-hidden="true"></i></a></h1>
						</div>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						...
						<!--<li><a href="#contact" class="scroll">Contact</a></li> -->
							<li><a href="#sign" class="scroll">Signin</a></li>
							<li><a href="http://localhost/legalnetsolution/client/index.php">Login</a></li>
						...
						<div class="callbacks_container">
							<ul class="rslides callbacks callbacks1" id="slider4">
								...
								<li>
									<div class="agileits-banner-info">
										<h3>International
											<div class="border"></div> <span>Law station</span></h3>
										<div class="w3-button">
											<div class="w3ls-button">
												<a href="#about" class="scroll hvr-shutter-out-vertical">About</a>
											</div>
		...
		<!--	<h6>Lorem ipsum dolor sit amet,Phasellus dapibus felis elit, sed accumsan arcu gravida vitae.</h6>-->
			<form action="action.php" method="POST">
				<div class="contact-left agileits-w3layouts free_w3ls_agile">
					...
					<input  class="email" type="text"  name="number" placeholder="Mobile Number" >
	...
	<div class="footer">
		<div class="container">
			...
			<div class="agileinfo_footer_bottom1">
				...
				<p>© 2019 Online Court Management</p>
			</div>
		</div>
	</div>
	<!-- //footer -->
