        ...
        <div  class="widget-content nopadding">
          <form action="#" method="POST" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="id" placeholder="Enter case details " />
              </div>
            </div>
           ...
           include('confi.php');
            ...
            <!--  <div class="controls">
                <input type="text" class="span11" name="lawyer" placeholder=" Lawyer contact details" />
              </div>-->
            </div>
...
if (isset($_POST["submit"])) {
   ...
   $lawyers = $_POST["lawyer"];
    ...
    $approve="NEW";
     $sql ="select * from request where caseid = '".$case."' and lawyer = '".$lawyers."'  and message = '".$message."' and clientname = '".$client."'  ";
