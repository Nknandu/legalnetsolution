      ...
      <div class="widget-box" >
        ...
        <div  class="widget-content nopadding">
          <form action="#" method="POST" class="form-horizontal">
            ...
            <!--  <div class="controls">-->
            <!--    <input type="number"   class="span11" name="rount_no" placeholder="Enter your rounting id " />-->
            <!--  </div>-->
            <!--</div>-->
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input type="number" maxlength="5" class="span11"  name="account_no" placeholder="Account  number" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" maxlength="12" class="span11" name="name_account" placeholder=" account" />
              </div>
            </div>
            <div class="control-group">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="span11" name="type"/>
...
if (isset($_POST["submit"])) {
   ...
   $name = $_POST["name_account"];
    $bankname = $_POST["bank_name"];
     ...
     $sql ="select * from bankdetails where rount_no = '".$rount."' and account_no = '".$account."' and name_account = '".$name."' and bank_name = '".$bankname."' and 	type = '". $type."'  ";
   ...
   if ($count == 0) {
       $query ="INSERT INTO bankdetails(account_no,name_account,bank_name,type) values('$account','$name','$bankname','$type')";
