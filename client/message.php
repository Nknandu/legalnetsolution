        ...
        <div  class="widget-content nopadding">
          <form action="#" method="POST" class="form-horizontal">
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11"  name="client" value="<?php echo $_SESSION["clientname"] ; ?>" />
              </div>
            </div>
            ...
            <div class="control-group">
             ...
             <div class="controls">
                <input type="text" class="span11"  name="lawyer" value="<?php echo $lawyer; ?>" />
              </div>
...
if (isset($_POST["submit"])) {
   ...
   $mesage = $_POST["mesage"];
    ...
    $approve="NEW";
     $sql ="select * from message where client = '".$client."' and lawyer ='".$lawyer."' and message = '".$mesage."'  and 	lawyername = '".$lawyer."'  ";
   ...
   if ($count == 0) {
       $query ="INSERT INTO  message(client,lawyer,message,lawyername) values('$client','$lawyer','$mesage','$lawyer')";
