        ...
        <div  class="widget-content nopadding">
          <form action="#" method="POST" class="form-horizontal">
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" class="span11" name="rount_no" id="1" placeholder="Enter your id " />
              </div>
            </div>
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input type="number" class="span11"  name="account_no" id="2" placeholder="Cateogry" />
              </div>
            </div>
            
            <div class="control-group">
              <label class="control-label">Name of the Bank Account  :</label>
              <div class="controls">
                <input type="text" class="span11" name="name_account" id="3" placeholder=" Lawyer contact details" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Bank Name  :</label>
              <div class="controls">
                <input type="text" class="span11" name="bank_name"  id="4"placeholder=" Lawyer contact details" />
              </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" class="span11" id="5" name="type"/>
...
if (isset($_POST["submit"])) {
  $rount = $_POST["rount_no"];
   ...
   $name = $_POST["name_account"];
    ...
    $sql = "update  bankdetails set rount_no ='$rount',account_no='$account',name_account='$name',bank_name	='$bankname',type='$type'  where id='$vid' ";
    if ($conn->query($sql) === TRUE) {
        //mysql_query("delete from expense where e_id='$eid'");
        echo " <script>alert('Successfully Upadted  Details');window.location.href='viewbank.php';</script>";
    } else {
        echo " <script>alert('Deatils not able to edit...!');window.location.href='viewbank.php';</script>";
    }

}
$sql = "SELECT * from   bankdetails where id='".$vid."'";
...
?>
<script>
    var barcode = "<?php echo $rount; ?>";
    var productname = "<?php echo $account; ?>";
    var discount = "<?php echo $name; ?>";
     var nopieces = "<?php echo $bankname; ?>";
      var hsncode = "<?php echo $type; ?>";
      
     
     
    document.getElementById("1").value = barcode;
     document.getElementById("2").value = productname;
      document.getElementById("3").value = discount;
       document.getElementById("4").value = nopieces;
        document.getElementById("5").value = hsncode;
