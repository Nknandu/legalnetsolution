...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Case</a> </div>
    <h1>Case Detais <?php echo $_SESSION["clientname"] ; ?>   </h1>
  </div>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                   ...
                   include('confi.php');
                       ...
                       $count = 1;
                       $sql = "SELECT * from payment where clientname ='".$_SESSION["clientname"]."' ";
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo"<td width='10'>" . $count . "</td>";
                                                 ...
                                                 echo"<td width='100'>" . $row["amount"] . "</td>";
