...
<body>
				...
				<div class="navbar-top">
					...
					<div class="navbar-header">
						...
						<div class="navbar-brand logo ">
							<h1><a href="index.html"> Legal NetSolution <i class="fa fa-balance-scale" aria-hidden="true"></i></a></h1>
						</div>
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav link-effect-4">
							...
							<li><a href="#sign" class="scroll">Free Registration</a></li>
							<li><a href="http://solution360.in/legalnetsolution/client/index.php">Login</a></li>
						...
						<div class="callbacks_container">
							<ul class="rslides callbacks callbacks1" id="slider4">
								...
								<li>
									<div class="agileits-banner-info">
										<h3>Welcome
											<div class="border"></div> <span>to the Legal Net solution</span></h3>
										<div class="w3-button">
											<div class="w3ls-button">
												<a href="#about" class="scroll hvr-shutter-out-vertical">About</a>
											</div>
		...
		<div class="container">
			<div class="w3l-about-grids_inner">
				<div class="col-md-6 w3ls-about-left">
					<h2>Welcome to the Legal Netsolution</h2>
					<h6>Lawyers are men who hire out their words and anger.</h6>
					<p>Discourage litigation. Persuade your neighbor to compromise whenever you can. As a peacemaker the lawyer has a superior opportunity of being a good man. There will still be business enough</p>
					<a href="#contact" class="scroll hvr-shutter-out-vertical">Contact</a>
				</div>
	...
	<div class="free_agile_consultation contact">
		...
		<div id="sign" class="col-md-6 free_consultation_agile">
		...
		<!--	<h6>Lorem ipsum dolor sit amet,Phasellus dapibus felis elit, sed accumsan arcu gravida vitae.</h6>-->
			<form action="" method="POST">
				<div class="contact-left agileits-w3layouts free_w3ls_agile">
					...
					<input class="email" name="address" type="TEXT" placeholder="Address" required="">
...
if (isset($_POST["submit"])) {
   ...
   $address = $_POST["address"];
    ...
    $status="NEW";
     $sql ="select * from registration where name = '".$name."' and email = '".$email."' and adderss = '".$address."'  and phone = '".$number."'and username = '".$username."' and password = '".$password."' ";
   ...
   if ($count == 0) {
       $query ="INSERT INTO  registration(name,email,adderss,phone,username,password ) values('$name','$email','$address','$number','$username','NEW')";
							...
							<ul class="rslides callbacks callbacks1" id="slider3">
								<li>
									<div class="agileinfo-offer-grid">
										...
										<h5>will rowers</h5>
										<p>The minute you read something you can’t understand, you can almost be sure it was drawn up by a lawyer.</p>
									</div>
								</li>
								<li>
									<div class="agileinfo-offer-grid">
										<h4><i class="fa fa-quote-left" aria-hidden="true"></i></h4>
										<h5>luke</h5>
										<p>Woe unto you also, ye lawyers! for ye lade men with burdens grievous to be borne, and ye yourselves touch not the burdens with one of your fingers.</p>
									</div>
								</li>
								<li>
									<div class="agileinfo-offer-grid">
										<h4><i class="fa fa-quote-left" aria-hidden="true"></i></h4>
										<h5>hentry david</h5></h5>
										<p>The lawyers’ truth is not Truth, but consistency or a consistent expediency.</p>
									</div>
								</li>
							</ul>
						</div>
	...
	<div class="footer">
		<div class="container">
			...
			<div class="agileinfo_footer_bottom1">
				...
				<p>© 2017 Legal Net Solution. All rights reserved | Design by <a href="#">MAGVN</a></p>
			</div>
		</div>
	</div>
	<!-- //footer -->
