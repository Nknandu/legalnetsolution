    ...
    <div class="span6">
      ...
      <div class="widget-box" >
        <div class="widget-title"> <span class="icon"> <i class="icon-align-justify"></i> </span>
          <h5>Client-info <?php echo $_SESSION["name"] ;?> </h5>
        </div>
        <div  class="widget-content nopadding">
          <form action="#" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
             ...
             <div class="control-group">
              <label class="control-label">Time of Payment :</label>
              <div class="controls">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="number" class="span11" name="Status" id="phone" placeholder="amount details" />
              </div>
            </div>
...
if (isset($_POST["submit"])) {
   ...
   $lawyer =$_SESSION["name"];
     ...
     $sql ="select * from payment where date ='".$current_date."' and time ='".$current_time."' and amount ='".$number."' and clientname ='".$caseid."'   ";
     
  
    $res = mysql_query($sql) or die(mysql_error());
    $count = mysql_num_rows($res);  
   if ($count == 0) {
       $query ="INSERT INTO payment(date,time,amount,clientname,lawyername) values('$current_date','$current_time','$number','$caseid','$lawyer')";
