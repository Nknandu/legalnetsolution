        ...
        <div  class="widget-content nopadding">
          <form action="#" method="POST" class="form-horizontal">
            <div class="control-group">
              <label class="control-label">Lawyer Name :</label>
              <div class="controls">
                <input type="text" class="span11" name="name" id="name" placeholder="First name" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Experience :</label>
              <div class="controls">
                <input type="text" class="span11" name="experience" id="experience" placeholder="years" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Category :</label>
              <div class="controls">
                <input type="text" class="span11"  name="category" id="category" placeholder="Law" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Email :</label>
              <div class="controls">
                <input type="text" class="span11"  name="email" id="email" placeholder="mail" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="phone" id="phone" placeholder=" contactnumber" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Praticearea :</label>
              <div class="controls">
                <input type="text" class="span11"  name="pratice" id="pratice" placeholder="" />
              </div>
            </div><div class="control-group">
              <label class="control-label">Username :</label>
              <div class="controls">
                <input type="text" class="span11"  name="user"  id="user" placeholder="username" />
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block">Password field</span>
              </div>
            </div>
...
if (isset($_POST["submit"])) {
    ...
    $sql = "update addlawyers set name ='$name',experience ='$experience',category ='$category',email='$email',phone='$number',pratice='$pratice',user='$username',password='$password'  where id='$vid' ";
 
echo($pratice);
    if ($conn->query($sql) === TRUE) {
        //mysql_query("delete from expense where e_id='$eid'");
        echo " <script>alert('Successfully Upadted  Details');window.location.href='viewlawyers.php';</script>";
    } else {
        echo " <script>alert('Deatils not able to edit...!');window.location.href='viewlawyers.php';</script>";
    }
}
$sql = "SELECT * from  addlawyers where id='".$vid."'";
echo($sql);
...
<script>
    var barcode = "<?php echo $name; ?>";
    var experience = "<?php echo $experience; ?>";
    var category = "<?php echo $category; ?>";  
    var email = "<?php echo $email; ?>";
    var number = "<?php echo $number; ?>";
    var pratice = "<?php echo $pratice; ?>";
     ...
     document.getElementById("category").value = category;
      document.getElementById("email").value = email;
       document.getElementById("phone").value = number;
        document.getElementById("pratice").value = pratice;
