        ...
        <div  class="widget-content nopadding">
          <form action="#" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="experience" placeholder="years" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Category :</label>
              <div class="controls">
                <input type="text" class="span11"  name="category" placeholder="Law" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Email :</label>
              <div class="controls">
                <input type="text" class="span11"  name="email" placeholder="mail" />
              </div>
            </div>
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="phone" placeholder=" contactnumber" />
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">Praticearea :</label>
              <div class="controls">
                <input type="text" class="span11"  name="pratice" placeholder="" />
              </div>
...
if (isset($_POST["submit"])) {
    ...
    $password = $_POST["password"];
     $sql ="select * from addlawyers where name = '".$name."'and experience = '".$experience."'and category = '".$category."'  and email = '".$email."' and   phone = '".$number."'and pratice = '".$pratice."'and user = '".$username."' and password = '".$password."' ";
   ...
   if ($count == 0) {
       $query ="INSERT INTO  addlawyers(name,experience,category,email,phone,pratice,user,password) values('$name','$experience','$category','$email','$number','$pratice','$username','$password')";
