          ...
          <form action="#" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
             ...
             <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11"  name="address" id="address" placeholder="address" />
              </div>
            </div>
...
if (isset($_POST["submit"])) {
   ...
   $address = $_POST["address"];
    ...
    $sql = "update registration set name ='$name',email='$email',adderss='$address',phone='$number',username='$username',password='$password'  where id='$vid' ";
    if ($conn->query($sql) === TRUE) {
        //mysql_query("delete from expense where e_id='$eid'");
        echo " <script>alert('Successfully Upadted  Details');window.location.href='viewclients.php';</script>";
    } else {
        echo " <script>alert('Deatils not able to edit...!');window.location.href='viewclients.php';</script>";
    }
...
<script>
    ...
    document.getElementById("email").value = amount;
     document.getElementById("address").value = productname;
      document.getElementById("phone").value = discount;
       document.getElementById("user").value = nopieces;
        document.getElementById("password").value = hsncode;
