                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                echo"<td width='10'>" . $count . "</td>";
                                                 ...
                                                 echo"<td width='100'>" . $row["username"] . "</td>";
                                                  ...
                                                  echo '<td><a class="btn btn-warning " href= "editclient.php?id='.$row["id"].'"><i class="icon-pencil"></i></a><a class="btn btn-danger" href="deleteclient.php?id='.$row["id"].'"><i class="icon-trash"  ></i></a></td>';
                                                echo "</tr>";
                                                $count++ ;
                                                ?>
                                                <?php
