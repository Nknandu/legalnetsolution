                   ...
                   include('confi.php');
                       ...
                       $sql = "SELECT * from caseregistration where lawyername ='".$_SESSION["name"]."'";
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                if($row["status"]=='NEW')
                                                {
                                                echo'<td  style = "text-align:center;"> <a class="btn btn-success"  href="approveCASE.php?id='.$row["id"].'">Approve</a>';
                                                echo' <a class="btn btn-danger"  href="rejectCASE.php?id='.$row["id"].'">Reject</a></td>';
                                                }else{
